...
app.get('/', (req, res) => res.send('Agente IA Sofia con Claude Opus activo'));
        ...
        return dgSTT;
                                          ...
                                          const req = https.request(options, (res) => {
                                                      ...
                                                      res.on('end', () => {
                                                                    try {
                                                                                    ...
                                                                                    console.log('Respuesta Claude raw:', JSON.stringify(parsed).substring(0, 200));
                                                                                    if (parsed.error) {
         ...
         async function generateAndSendResponse(userText) {
                 try {
                   ...
                   const responseText = await callClaude(conversationHistory);
...
server.listen(PORT, () => console.log(`Servidor corriendo en puerto ${PORT} con Claude claude-opus-4-5`));
